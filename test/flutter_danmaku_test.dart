...
// import 'package:flutter_test/flutter_testr_danmaku.dart';
//
// void main() {
...
//           FlutterDanmakuBullet(danmakuId, danmakuText);
//       Size bulletSize = Size(10, 10);
//       FlutterDanmakuBulletModel bulletModel = FlutterDanmakuBulletModel(
//           id: danmakuId,
...
//       expect(bulletModel.maxRunDistance,
//           bulletModel.bulletSize.width + FlutterDanmakuConfig.areaSize.width);
//       expect(bulletModel.offsetX, bulletModel.runDistance - bulletSize.width);
//       bulletModel.bulletType = FlutterDanmakuBulletType.fixed;
//       expect(bulletModel.offsetX,
...
//
//       expect(
//           bulletModel.everyFrameRunDistance,
//           FlutterDanmakuUtils.getBulletEveryFrameRateRunDistance(
//               bulletSize.width));
//       bulletModel.runNextFrame();
//       expect(bulletModel.runDistance,
//           bulletModel.everyFrameRunDistance * FlutterDanmakuConfig.bulletRate);
//       bulletModel.runNextFrame();
//       expect(
//           bulletModel.runDistance,
//           bulletModel.everyFrameRunDistance *
//               FlutterDanmakuConfig.bulletRate *
//               2);
//       double runDistance = bulletModel.runDistance;
//       expect(runDistance > bulletModel.maxRunDistance, bulletModel.allOutLeave);
//       expect(bulletModel.needRunDistance, width + bulletModel.bulletSize.width);
//       expect(bulletModel.remainingDistance,
//           bulletModel.needRunDistance - bulletModel.runDistance);
//       expect(bulletModel.leaveScreenRemainderTime,
//           bulletModel.remainingDistance / bulletModel.everyFrameRunDistance);
//       expect(bullet.buildText().runtimeType, Text);
//       flutterDanmakuController.resizeArea(Size(500, 500));
//       AddBulletResBody addRes = flutterDanmakuController.addDanmaku(
//           'hello world',
//           builder: (Text textWidget) => Container(child: textWidget));
//       FlutterDanmakuBulletModel bullet1 = flutterDanmakuController.bullets
//           .firstWhere((element) => element.id == addRes.data,
//               orElse: () => null);
...
//       expect(
//           FlutterDanmakuUtils.getDanmakuBulletSizeByText('hello world')
//               .runtimeType,
//           Size);
//     });
//
...
//       FlutterDanmakuBulletModel bulletModel = flutterDanmakuBulletManager
//           .initBullet(text, trackId, bulletSize, offsetY);
...
//       expect(
//           flutterDanmakuBulletManager.bulletsMap[bulletModel.id], bulletModel);
//       expect(flutterDanmakuBulletManager.bulletKeys[0], bulletModel.id);
//       expect(
//           bulletModel.everyFrameRunDistance,
//           FlutterDanmakuUtils.getBulletEveryFrameRateRunDistance(
//               bulletSize.width));
//       AddBulletResBody addBulletResBody =
//           AddBulletResBody(AddBulletResCode.success);
//       expect(addBulletResBody.code, AddBulletResCode.success);
//       AddBulletResBody addBulletResBody1 =
//           AddBulletResBody(AddBulletResCode.noSpace);
...
//       expect(
//           FlutterDanmakuUtils.getBulletEveryFrameRateRunDistance(bulletWidth),
//           FlutterDanmakuConfig.baseRunDistance +
//               (bulletWidth /
//                   FlutterDanmakuConfig.everyFrameRateRunDistanceScale));
//     });
//
...
//       double offsetY = 0;
//       FlutterDanmakuBulletModel bullet1 = flutterDanmakuBulletManager
//           .initBullet(bulletText, trackId, bulletSize, offsetY);
//       UniqueKey bullet1Key = bullet1.id;
//       expect(flutterDanmakuBulletManager.bulletsMap[bullet1Key], bullet1);
//       expect(
//           flutterDanmakuBulletManager.bulletsMap.containsKey(bullet1Key), true);
//       flutterDanmakuBulletManager.removeBulletByKey(bullet1Key);
//       expect(flutterDanmakuBulletManager.bulletsMap.containsKey(bullet1Key),
//           false);
//     });
//
//     test('remainderTimeLeaveScreen', () {
//       FlutterDanmakuConfig.areaSize = Size(500, 500);
//       double remainderFrame =
//           FlutterDanmakuUtils.remainderTimeLeaveScreen(80, 10, 5);
...
//       flutterDanmakuController.resizeArea(Size(500, 500));
//       flutterDanmakuController.addDanmaku('hello world');
//       UniqueKey bottomBulletId = flutterDanmakuController
//           .addDanmaku('hello world',
//               position: FlutterDanmakuBulletPosition.bottom)
//           .data;
//       expect(flutterDanmakuController.bullets.last.id, bottomBulletId);
//       flutterDanmakuController.resizeArea(Size(20, 500));
//       expect(
//           flutterDanmakuController.bullets
//               .firstWhere((element) => element.id == bottomBulletId)
//               .trackId,
//           flutterDanmakuController.tracks.last.id);
//       flutterDanmakuController.resizeArea(Size(500, 500));
//     });
//   });
//
...
//       expect(FlutterDanmakuConfig.showAreaHeight,
//           areaHeight * FlutterDanmakuConfig.showAreaPercent);
//       flutterDanmakuTrackManager.buildTrack(trackHeight);
//       flutterDanmakuTrackManager.buildTrack(trackHeight);
//       expect(flutterDanmakuTrackManager.remainderHeight,
//           FlutterDanmakuConfig.showAreaHeight - trackHeight - trackHeight);
//       expect(FlutterDanmakuConfig.bulletBaseShowDuration.runtimeType, Duration);
//       Size textSize = Size(10, 10);
//       expect(FlutterDanmakuConfig.getAreaOfChildOffsetY(textSize: textSize),
//           (areaHeight % textSize.height) / 2);
//     });
//   });
//
...
//       expect(
//           trackSecend.offsetTop, trackFirst.offsetTop + trackFirst.trackHeight);
//       expect(flutterDanmakuTrackManager.tracks.length, 2);
//       double trackHeight2 = 80;
//       track.trackHeight = trackHeight2;
//       expect(track.offsetTop,
//           flutterDanmakuTrackManager.allTrackHeight - trackHeight2);
...
//       FlutterDanmakuConfig.showAreaPercent = 0.5;
//       expect(flutterDanmakuTrackManager.areaAllowBuildNewTrack(trackHeight),
//           false);
//     });
//
...
//           GlobalKey<FlutterDanmakuAreaState>();
...
//           Directionality(textDirection: TextDirection.ltr, child: area));
...
//       await tester.pumpWidget(
//           Directionality(textDirection: TextDirection.ltr, child: childArea));
//       controller.init(Size(400, 400));
//       await tester.pump(Duration(seconds: 1));
...
//       }
//
//       Widget bullet1 = key.currentState
//           .buildBulletToScreen(key.currentContext, controller.bullets.last);
//       expect(bullet1.runtimeType, Positioned);
//
//       controller.addDanmaku('hello world', builder: builder);
//       FlutterDanmakuBullet bullet2 = FlutterDanmakuBullet(
//           controller.bullets.last.id, controller.bullets.last.text,
//           builder: controller.bullets.last.builder);
...
//       controller.addDanmaku('hello world',
//           position: FlutterDanmakuBulletPosition.bottom);
//       AddBulletResBody addRes = controller.addDanmaku('hello world',
//           position: FlutterDanmakuBulletPosition.bottom);
...
//       expect(
//           controller.bullets.singleWhere(
//               (element) => element.id == firstBulletId,
//               orElse: () => null),
//           null);
//       expect(controller.tracks.first.lastBulletId, null);
//       UniqueKey fixedBulletId = controller
//           .addDanmaku('hello world', bulletType: FlutterDanmakuBulletType.fixed)
//           .data;
//       FlutterDanmakuBulletModel fixedBullet = controller.bullets
//           .singleWhere((element) => element.id == fixedBulletId);
...
//
//       FlutterDanmakuRenderManager flutterDanmakuRenderManager =
...
//
//       expect(
//           FlutterDanmakuUtils.trackInsertBulletHasBump(
//               bulletMap1, Size(30, 50)),
//           false);
//       expect(
//           FlutterDanmakuUtils.trackInsertBulletHasBump(bulletMap1, Size(5, 50)),
//           false);
//       expect(
//           FlutterDanmakuUtils.trackInsertBulletHasBump(
//               bulletMap1, Size(500, 50)),
//           true);
//
...
//       expect(FlutterDanmakuConfig.bulletLabelSize, size);
//     });
//   });
// }
